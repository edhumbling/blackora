        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="order-2 lg:order-1 animate-fade-in-left">
            ...
            <p className="text-muted-foreground mb-4">
              Founded by Hardy Yusif and his passionate team, Authentic African Foods was born from a desire to share the rich culinary heritage of Africa with the world. Our journey began in Prince George, Canada, where we set out to create a dining experience that celebrates the diverse flavors and cultural traditions of African cuisine.
            </p>

            <p className="text-muted-foreground mb-6">
              Every dish at Authentic African Foods tells a story—a story of family recipes passed down through generations, of traditional cooking techniques preserved with care, and of fresh, quality ingredients sourced with integrity. We invite you to join us in celebrating the vibrant tapestry of African cuisine.
            </p>
