          ...
          <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
            ...
            <div className={`w-full lg:w-1/2 transition-all duration-700 ${isVisible ? 'opacity-100' : 'opacity-0 translate-x-8'}`}>
              ...
              <p className="text-white/80 mb-8">
                At Blackora, we believe dining is more than just food—it's an experience that engages all the senses and creates lasting memories. Our commitment to exceptional service matches the quality of our authentic African cuisine.
              </p>
