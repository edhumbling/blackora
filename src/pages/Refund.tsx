        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <h2>1. Overview</h2>
              <p>
                At Blackora Restaurant, we are committed to ensuring your satisfaction with our food and services. 
              ...
              <ul>
                ...
                <li>Email us at refunds@blackora.com</li>
