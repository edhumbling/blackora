        ...
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p>
                Welcome to Blackora Restaurant ("we," "our," or "us"). These Terms of Service ("Terms") govern your use of our website, mobile application, and services (collectively, the "Services").
              </p>
              <p>
              ...
              <ul>
                ...
                <li>To impersonate or attempt to impersonate Blackora, a Blackora employee, another user, or any other person or entity.</li>
              ...
              <p>
                The Services and their entire contents, features, and functionality (including but not limited to all information, software, text, displays, images, video, and audio, and the design, selection, and arrangement thereof) are owned by Blackora, its licensors, or other providers of such material and are protected by Canadian and international copyright, trademark, patent, trade secret, and other intellectual property or proprietary rights laws.
              </p>
              
              <h2>7. Limitation of Liability</h2>
              <p>
                In no event will Blackora, its affiliates, or their licensors, service providers, employees, agents, officers, or directors be liable for damages of any kind, under any legal theory, arising out of or in connection with your use, or inability to use, the Services, including any direct, indirect, special, incidental, consequential, or punitive damages.
              </p>
              ...
              <p>
                Questions or comments about the Services or these Terms may be directed to our customer service team at info@blackora.com or by calling us at (250) 123-4567.
              </p>
            </div>
          </div>
        </div>
