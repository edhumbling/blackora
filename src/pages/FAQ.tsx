          ...
          <div className="max-w-4xl mx-auto">
              ...
              <Accordion type="single" collapsible className="space-y-4">
                <AccordionItem value="item-1" className="border rounded-lg p-1">
                  ...
                  <AccordionContent className="px-4 py-2">
                    Blackora specializes in authentic African cuisine, with a focus on traditional dishes from various regions 
                ...
                <AccordionItem value="item-8" className="border rounded-lg p-1">
                  ...
                  <AccordionContent className="px-4 py-2">
                    ...
                    events@blackora.com or call (250) 123-4567 ext. 2.
                  </AccordionContent>
                </AccordionItem>
            ...
            <div className="mt-12 bg-secondary/50 p-6 rounded-lg">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="mailto:info@blackora.com" className="inline-flex">
