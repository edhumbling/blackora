      ...
      <div className="pt-32 pb-10 px-4 md:px-6 lg:px-8">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-3xl md:text-5xl font-serif font-bold mb-4">About Blackora</h1>
        ...
        <div className="container mx-auto">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-6">
              At Blackora, our mission is to celebrate and share the diverse culinary traditions of Africa with our community. 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                Chef Hardy Yusif, the creative force behind Blackora, brings over 15 years of culinary expertise to our kitchen. 
              ...
              <p className="text-muted-foreground mb-6">
                "Food is more than sustenance—it's a story, a heritage, and a bridge between cultures," says Hardy. "At Blackora, 
      ...
      <div className="py-20 px-4 sm:px-6">
        <div className="container mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-3xl mx-auto">
            We invite you to experience the flavors, warmth, and hospitality of Blackora. Whether you're new to African cuisine 
